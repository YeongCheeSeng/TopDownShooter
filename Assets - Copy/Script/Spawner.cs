...
public class Spawner : MonoBehaviour
{
    ...
    public float MaxSpawmCooldown = 2f;
    ...
    void Update()
    {
        ...
        switch (randomSpawnPos)
        {
            ...
            case 1:
                Instantiate(Monsters[randomIndex], Bottom.position + new Vector3(Random.Range(MinX, MaxX), 0), transform.rotation);
                break;
        ...
        _spawnTimer = Random.Range(MinSpawnCooldown, MaxSpawmCooldown);
    }
}
